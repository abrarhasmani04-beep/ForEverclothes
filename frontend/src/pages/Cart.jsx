        ...
        cartData.map((item,index)=>{
         ...
         return (
          <div key={index} className="py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] item-center gap-4">
            ...
            <input onChange={(e)=> e.target.value === '' || e.target.value === '0' ? null : updateQuantity(item._id,item.size,Number(e.target.value))} className="border w-20 h-8 text-center px-1 py-0 rounded" type="number" min={1} defaultValue={item.quantity}/>
